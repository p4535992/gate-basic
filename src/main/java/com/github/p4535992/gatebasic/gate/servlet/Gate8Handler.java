...
public class Gate8Handler implements HttpRequestHandler {
  
  private static final Logger log = Logger.getLogger(Gate8Handler.class);
   ...
   * controller reference will be injected by Spring
